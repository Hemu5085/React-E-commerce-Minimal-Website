...
const Newsletters = () => {
  return (
    <div className='bg-[#1E2832 bg-opacity-5 xl:px-28 px-4 py-16]'>
        <h2 className='text-3xl font-semibold capitalize text-center my-8 mb-8'>Follow products and discounts On Instagram</h2>
        ...
        <div className='flex flex-wrap gap-4 items-center justify-center mb-20'>
            ...
            <Link to="/">
                <img src="/public/images/instagram/img6.png" alt="" />
            </Link>
        </div>
        ...
        <div>
            <h2 className='text-3xl font-semibold capitalize text-center my-8 mb-8'>Or subscribe to the newsletter</h2>
